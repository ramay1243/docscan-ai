...
SMART_ANALYSIS_CONFIG = {
    'business_plan': {
        'name': 'Бизнес-план / Пояснительная записка',
        'keywords': [
            'бизнес-план', 'бизнес план', 'бизнес-план для получения социального контракта',
            'социальный контракт', 'соцконтракт', 'план действий', 'ожидаемые результаты',
            'исходя из контекста', 'прогнозируемых доходов', 'расчет первоначальных затрат'
        ],
        'expert_areas': ['Бизнес-планирование', 'Финансы', 'Оценка рисков проекта']
    },
    'lease': {
        'name': 'Договор аренды',
...
# Лимиты для юридического чата (вопросов в день)
CHAT_LIMITS = {
    'free': 1,  # Бесплатный тариф: 1 вопрос в день
    'standard': 5,  # Стандарт: 5 вопросов/день
    'premium': 15,  # Премиум: 15 вопросов/день
    'business_start': 50,  # Бизнес Старт: 50 вопросов/день
    'business_pro': 50,  # Бизнес Про: 50 вопросов/день
    'business_max': 50,  # Бизнес Макс: 50 вопросов/день
    'business_unlimited': 1000  # Бизнес Безлимит: 1000 вопросов/день (практически безлимит)
}
