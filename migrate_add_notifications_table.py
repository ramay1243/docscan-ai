#!/usr/bin/env python3
"""
Скрипт миграции: Создание таблицы notifications для уведомлений пользователей
"""
...
def migrate():
    ...
    backup_path = f"{db_path}.backup_notifications_{int(os.path.getmtime(db_path))}"
    ...
    try:
        ...
        cursor.execute("CREATE INDEX idx_notifications_is_read ON notifications(user_id, is_read)")
...
if __name__ == '__main__':
    print("=" * 50)
    print("Миграция: Создание таблицы notifications")
    print("=" * 50)
    print()
